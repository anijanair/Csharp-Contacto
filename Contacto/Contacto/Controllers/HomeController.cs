...
namespace Contacto.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult SingleContact(Contact contact)
        {
            return View();
        }
    ...
    public class ContactRepository
    {
                ...
                
        {
            using (var connection = CreateConnection())
            {
                connection.Execute("UPDATE CONTACTS LASTNAME = @lastname, FIRSTNAME = @firstname where ID = @id", new { lastname = contact.LastName, firstname = contact.FirstName , id = contact.ID});
            }
        }
